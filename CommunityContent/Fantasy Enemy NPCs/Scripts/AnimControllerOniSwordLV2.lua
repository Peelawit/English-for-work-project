...
local HUMANOID_2_RIG = script:GetCustomProperty("Humanoid2Rig"):WaitForObject()
local MESH = HUMANOID_2_RIG
...
function PlayAttack()
	if attackIndex == 1 then
		MESH:PlayAnimation("2hand_sword_slash_left", {playbackRate = 0.6})
		attackIndex = 2
	elseif attackIndex == 2 then
		MESH:PlayAnimation("2hand_sword_slash_right", {playbackRate = 0.6})
		attackIndex = 3
	elseif attackIndex == 3 then
		MESH:PlayAnimation("2hand_sword_slash_vertical", {playbackRate = 0.6})
		attackIndex = 1
	else 
		MESH:PlayAnimation("2hand_sword_slash_left", {playbackRate = 0.6})
		attackIndex = 1
