...
local WALK_STANCE = script:GetCustomProperty("WalkStance") or "zombie_unarmed_run_forward"
local RUN_STANCE = script:GetCustomProperty("RunStance") or "zombie_unarmed_walk_forward"
