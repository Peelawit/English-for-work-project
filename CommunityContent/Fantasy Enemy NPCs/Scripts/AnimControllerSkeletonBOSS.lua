...
local WALK_STANCE = script:GetCustomProperty("WalkStance") or "dual_katana_walk_forward"
local RUN_STANCE = script:GetCustomProperty("RunStance") or "dual_katana_run_forward"
...
function PlayAttack()
	if attackIndex == 1 then
		MESH:PlayAnimation("dual_melee_left_hand_slash_left", {playbackRate = 0.6})
		attackIndex = 2
	elseif attackIndex == 2 then
		MESH:PlayAnimation("dual_melee_left_hand_slash_right", {playbackRate = 0.6})
		attackIndex = 3
	elseif attackIndex == 3 then
		MESH:PlayAnimation("dual_melee_right_hand_slash_left", {playbackRate = 0.6})
		attackIndex = 1
	else
		MESH:PlayAnimation("dual_melee_right_hand_slash_right", {playbackRate = 0.6})
		attackIndex = 1
	end
